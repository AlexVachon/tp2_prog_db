...
CREATE TABLE Utilisateurs (
    UtilisateurID NUMBER GENERATED BY DEFAULT AS IDENTITY ( START WITH 1 INCREMENT BY 1 ) PRIMARY KEY,
    Nom VARCHAR2(50),
    Prenom VARCHAR2(50),
    Email VARCHAR2(100),
...
CREATE TABLE Annonces (
    AnnonceID NUMBER GENERATED BY DEFAULT AS IDENTITY ( START WITH 1 INCREMENT BY 1 ) PRIMARY KEY,
...
CREATE TABLE Reservations (
    ReservationID NUMBER GENERATED BY DEFAULT AS IDENTITY ( START WITH 1 INCREMENT BY 1 ) PRIMARY KEY,
    UtilisateurID NUMBER,
    AnnonceID NUMBER,
    DateDebut DATE,
    DateFin DATE,
...
CREATE TABLE Commentaires (
    CommentaireID NUMBER GENERATED BY DEFAULT AS IDENTITY ( START WITH 1 INCREMENT BY 1 ) PRIMARY KEY,
    UtilisateurID NUMBER,
    AnnonceID NUMBER,
    Note NUMBER,
...
CREATE TABLE Photos (
    PhotoID NUMBER GENERATED BY DEFAULT AS IDENTITY ( START WITH 1 INCREMENT BY 1 ) PRIMARY KEY,
    AnnonceID NUMBER,
...
CREATE TABLE Messages (
    MessageID NUMBER GENERATED BY DEFAULT AS IDENTITY ( START WITH 1 INCREMENT BY 1 ) PRIMARY KEY,
